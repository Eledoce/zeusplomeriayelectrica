    ...
    <div className="w-full relative">
      ...
      <div className="border-red-600 absolute top-0 w-full h-full flex flex-col justify-center items-center select-none">
        <img
          src={zeus}
          alt="Zeus"
          className="w-1/6 mb-5 hover:scale-105 transition-all"
        />
        <h1 className="text-7xl uppercase text-center top-0 text-white font-Staat hover:scale-105 transition-all">
          Plomeria y electrica Zeus
        </h1>
        <h2 className="text-2xl uppercase text-center text-gray-300 top-0 hover:scale-105 transition-all font-Montserrat">
